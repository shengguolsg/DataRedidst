!
    Subroutine OneTo1D_ComplexDataRedist( na, A, lda, nca, B, ldb, ncb, nblk, &
...
!      
! *** Note that this rutine use the Caterpillar algorithm, which may not be efficient, since it requires
! nprocs or nprocs-1 times communications. ***
!
!  .. Parameters ..
!  =================
...
!      
! =========================
! Written by Shengguo Li, Sept. 25, 2020
!
! This version works for the cases that some entries of Ms are zero. 
! 
! This version dose not use the Caterpillar algorithm, and implements a heuristic bipartite 
! graphic algorithm. 
! =============================================
...
! **** Asend2 is used for communications ****
      ...
      ! The following approach uses A istead of Asend2
      DO i=1, lenGs
...
!*  Require npcol-1 sychronization.                                     *
!************************************************************************
...
20       CONTINUE
    ...
    end Subroutine OneTo1D_ComplexDataRedist
